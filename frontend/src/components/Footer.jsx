    ...
    <footer className={`footer ${isHomeRoute ? "footer-home" : ""}`.trim()}>
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-nav-list">
            <li>
              <a href={GITHUB_PROFILE_URL} target="_blank" rel="noopener noreferrer" className="footer-social-link">
                <span className="icon">
                ...
                <span className="text">NexoryDev</span>
              </a>
            </li>
          </ul>
        </div>
